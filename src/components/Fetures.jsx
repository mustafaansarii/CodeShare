    ...
    <div className="container mx-auto py-20 px-4 max-w-7xl mt-10 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {featuresData.map((feature, index) => (
          <div 
            key={index}
            className={`border border-gray-700 rounded-xl p-6 hover:border-${feature.color}-500 transition-colors duration-300`}
          >
            <div className={`text-${feature.color}-500 text-3xl mb-4`}>
              <feature.icon />
            </div>
