      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white">About SnipLink</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              SnipLink is a cutting-edge platform for real-time code collaboration and sharing. We empower developers to create, share, and innovate together.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-gray-400">support@sniplink.com</li>
